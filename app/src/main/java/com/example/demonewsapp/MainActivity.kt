...
import com.example.demonewsapp.presentation.nvgraph.NavGraph
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // disables automatic addition of indents for system windows (navigation bar, status bar)
        ...
        setContent {
            DemoNewsAppTheme {
                ...
                // can be replaced with WindowInsetsController + ComposeView, edge-to-edge
